...
//  https://github.com/oneiro-ndev/tendermint.0.32.3/issues/851
// so for go versions < Go1.10 use our custom net.Conn creator
// that doesn't return an `Unimplemented error` for net.Conn.
// Before https://github.com/oneiro-ndev/tendermint.0.32.3/commit/49faa79bdce5663894b3febbf4955fb1d172df04
