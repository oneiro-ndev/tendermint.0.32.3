...
import (
	...
	bcv0 "github.com/oneiro-ndev/tendermint.0.32.3/blockchain/v0"
	bcv1 "github.com/oneiro-ndev/tendermint.0.32.3/blockchain/v1"
	cfg "github.com/oneiro-ndev/tendermint.0.32.3/config"
	"github.com/oneiro-ndev/tendermint.0.32.3/consensus"
	cs "github.com/oneiro-ndev/tendermint.0.32.3/consensus"
	"github.com/oneiro-ndev/tendermint.0.32.3/crypto"
	"github.com/oneiro-ndev/tendermint.0.32.3/evidence"
	...
	mempl "github.com/oneiro-ndev/tendermint.0.32.3/mempool"
	"github.com/oneiro-ndev/tendermint.0.32.3/p2p"
	"github.com/oneiro-ndev/tendermint.0.32.3/p2p/pex"
	"github.com/oneiro-ndev/tendermint.0.32.3/privval"
	"github.com/oneiro-ndev/tendermint.0.32.3/proxy"
	rpccore "github.com/oneiro-ndev/tendermint.0.32.3/rpc/core"
	ctypes "github.com/oneiro-ndev/tendermint.0.32.3/rpc/core/types"
	grpccore "github.com/oneiro-ndev/tendermint.0.32.3/rpc/grpc"
	rpcserver "github.com/oneiro-ndev/tendermint.0.32.3/rpc/lib/server"
	sm "github.com/oneiro-ndev/tendermint.0.32.3/state"
	"github.com/oneiro-ndev/tendermint.0.32.3/state/txindex"
	"github.com/oneiro-ndev/tendermint.0.32.3/state/txindex/kv"
	"github.com/oneiro-ndev/tendermint.0.32.3/state/txindex/null"
...
func createPEXReactorAndAddToSwitch(addrBook pex.AddrBook, config *cfg.Config,
	...
	pexReactor := pex.NewPEXReactor(addrBook,
		&pex.PEXReactorConfig{
			...
			// https://github.com/oneiro-ndev/tendermint.0.32.3/issues/3523
...
func NewNode(config *cfg.Config,
	...
	if pubKey == nil {
		// TODO: GetPubKey should return errors - https://github.com/oneiro-ndev/tendermint.0.32.3/issues/3602
...
func (n *Node) startRPC() ([]net.Listener, error) {
	...
	// See https://github.com/oneiro-ndev/tendermint.0.32.3/issues/3435
