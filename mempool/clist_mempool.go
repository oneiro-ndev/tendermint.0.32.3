...
import (
	...
	auto "github.com/oneiro-ndev/tendermint.0.32.3/libs/autofile"
	"github.com/oneiro-ndev/tendermint.0.32.3/libs/clist"
...
func (mem *CListMempool) Update(
	...
	for i, tx := range txs {
		...
		// Mempool after:
		//   100
		// https://github.com/oneiro-ndev/tendermint.0.32.3/issues/3322.
		if e, ok := mem.txsMap.Load(txKey(tx)); ok {
